      ...
      <div className="relative">
        <div className="relative bg-white/10 backdrop-blur-lg rounded-3xl p-6 sm:p-8 border-2 border-white/20 shadow-2xl">
          ...
          <div className="space-y-4">
            <div className="bg-white rounded-2xl p-4 shadow-xl transform hover:scale-105 transition-transform duration-300 animate-float">
            ...
            <div className="bg-white rounded-2xl p-4 shadow-xl transform hover:scale-105 transition-transform duration-300 animate-float animation-delay-1000">
              <div className="flex items-center gap-3 mb-3">
        ...
        {/* Floating stats */}
        <div className="absolute -bottom-6 -left-6 bg-white rounded-2xl p-4 shadow-2xl animate-float animation-delay-2000">
        ...
        <div className="absolute -top-6 -right-6 bg-white rounded-2xl p-4 shadow-2xl animate-float animation-delay-3000">
